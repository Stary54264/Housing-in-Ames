...
- Yanzun Jiang: Organized discussions and meetings; assigned tasks to group members; set up Github workspace for collaborating; refined the model by model selection tools; checked multicollinearity of the models; made the reference list; revised group member's work; combined group member's work together.
